    ...
    return (
        <div>
            <div className=" mb-5 " style={{marginTop:'5vh'}}>
                <h3 className='text-center mt-5 fw-  mb-4 subHeading'  style={{fontFamily:'"Arial",sans-serif'}}>Shop By Category</h3>
                <div className="row w-100 mx-auto justify-content-md-center  text-center mt-3 justify-content-start" id="cardHome" style={{fontFamily:'"Lato",sans-serif'}}>
